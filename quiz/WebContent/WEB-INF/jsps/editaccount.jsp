      ...
      <div class="row" id="centered-row">
        ...
        <div class="col-xs-5">
          <sf:form id="details" method="post" class="form-horizontal"
            action="${pageContext.request.contextPath}/changeaccount"
            commandName="user">
            ...
            <div class="form-group">
             <label for="inputCompany2" class="col-sm-5 control-label">Company</label>
              <div class="col-sm-7">
                <sf:select path="company.id" class="form-control" id="inputCompany2"
                        multiple="false">
                  <c:forEach items="${allcompanies}" var="item" varStatus="count">
            ...
            <div class="form-group">
             <label for="inputUserEnabled2" class="col-sm-5 control-label">User Enabled</label>
              <div class="col-sm-7">
                <sf:select path="enabled" class="form-control" id="inputUserEnabled2"
                        multiple="false">
                    <option>true</option>
                    <option>false</option>
                </sf:select>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <sf:input type="password" path="password"
                  ...
                  id="inputPassword2" placeholder="Password" readonly="true" />
                <div id="error-text">
