...
<script src="${pageContext.request.contextPath}/static/Scripts/groups.js"></script>
  ...
  <div id="wrap">
    <div class="container">
          ...
          <sec:authorize access="isAuthenticated()">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Users in Group: ${group_name}</h3>
              </div>
              <div class="panel-body">
                <table id="group-table" class="display"
                  ...
                  <tbody>
                    <c:forEach var="user" items="${users_in_group}">
                      <tr>
                        <td><c:out value="${user.username}"></c:out></td>
                        <td><c:out value="${user.name}"></c:out></td>
                        <td><c:out value="${user.email}"></c:out></td>
                        <td><c:out value="${user.company.name}"></c:out></td>
      ...
      <div class="row" id="buttons-left">
        ...
        <div class="col-xs-2">
          <a class="btn btn-primary" id="list_groups_button"
            role="button">List Groups</a>
        </div>
      </div>
    </div>
  </div>
